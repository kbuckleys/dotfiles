...
Item {
  ...
  readonly property int reach: Zenon.menuShadowPad
  ...
  Item {
    ...
    RectangularShadow {
      ...
      blur: Zenon.menuShadowBlur
      spread: Zenon.menuShadowGrow
      offset: Qt.vector2d(0, Zenon.menuShadowDrop)
      color: Zenon.menuShadowInk
    }
  }
